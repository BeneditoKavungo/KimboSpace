        ...
        <nav class="navbar navbar-light navbar-expand-md navigation-clean-search" style="margin: 0px;height: 57px;width: 1500px;color: rgb(51, 51, 51);background: rgba(255,255,255,0);">
                <div class="container"><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                    <div class="collapse navbar-collapse" id="navcol-1" style="width: 1093.61px;height: 445px;">
                        ...
                        </nav><a class="text-nowrap" data-bss-hover-animate="flash" href="cadastro.php" style="margin: 0px;margin-left: 547px;color: rgb(255,255,255);">Não possui uma conta?</a>
                        <ul class="navbar-nav">
                            <li class="nav-item"></li>
                            <li class="nav-item"></li>
                            <li class="nav-item"></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-4 footer-navigation">
                    ...
                    <p class="links"><a href="#">Página Principal</a><strong> · </strong><a href="#">Categorias</a><strong> · </strong><a href="#">Divulgue aqui</a><strong> ·&nbsp;&nbsp;</strong><a href="#">Sobre-Nós</a></p>
